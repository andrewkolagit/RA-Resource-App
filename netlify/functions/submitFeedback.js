...
exports.handler = async (event, context) => {
    ...
    const url = `https://api.airtable.com/v0/${process.env.AIRTABLE_BASE_ID}/YOUR_TABLE_NAME`; // Replace YOUR_TABLE_NAME
    const apiKey = process.env.AIRTABLE_API_KEY; // Access API key from environment variables
